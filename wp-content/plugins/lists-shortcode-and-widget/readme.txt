...
Tags: lists, ordered list, unordered list, shortcode, widgets, button, WYSIWYG editor, widget, sidebar
...
Easily create all different kinds of Ordered and Unordered Lists for your WordPress site. Insert Lists anywhere in your site - page/post editor, sidebars, template files. No coding is required. It is all done in a nice and easy interface.
...
**Insert Lists Anywhere in your site**

Basically Lists can be inserted anywhere in your site

* Page/post WYSIWYG editor by using the buttion in the editor
* In sidebars by using the OTW Shortcode Widget
* In template files by using the List's shortcode and WordPress do_shortcode function

**Custom styling**

If you need to further style a List here are your options:

* Each List shortcode has it's unique CSS class that can be used to style all Lists.
* Create a new class for each instance of a List shortcode in its interface so you can style it individually.
...
Please refer to [online documentation page](http://otwthemes.com/online-documentation-lists-shortcode-and-widget-plugin/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=cml) for more details.
