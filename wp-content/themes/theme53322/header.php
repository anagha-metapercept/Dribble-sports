...
<body <?php body_class(); ?>>
<div id="top-menu" class="top-menu-bar">
	...
	<?php } else { ?>
		<header class = "motopress-wrapper header-transparent">
			<div class="container">
				<div class="row">
					<div class="<?php echo cherry_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="wrapper/wrapper-header.php" data-motopress-wrapper-type="header" data-motopress-id="<?php echo uniqid() ?>">
						<?php get_template_part('wrapper/wrapper-header'); ?>
		...
		<?php if ( (of_get_option( 'px_slider_visibility', 'true' ) == "true") && is_front_page() ) { get_template_part('parallax-slider/parallaxSlider'); } ?>
