...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Twitter", "Facebook", "Flickr", "Github", "Rss", "Delicious", "Linkedin", "Google_plus") as $network) : ?>
			...
			<li class="social_li">
				<a class="social_link social_link__<?php echo strtolower($network); ?>" rel="tooltip" data-original-title="<?php echo strtolower($network); ?>" href="<?php echo $networks[$network]['link']; ?>">
					<?php if (($display == "both") or ($display =="icons")) { ?>
						<span class="social_ico"><i class="icon-<?php echo strtolower($network);?>"></i><?php echo $network; ?></span> 
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'flickr' => '', 'flickr_label' => '', 'github' => '', 'github_label' => '', 'rss' => '', 'rss_label' => '', 'delicious' => '', 'delicious_label' => '', 'linkedin' => '', 'linkedin_label' => '', 'google_plus' => '', 'google_plus_label' => '', 'display' => 'icons', 'text' => '');
