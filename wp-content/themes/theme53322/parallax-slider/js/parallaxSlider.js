(function($){
     $.fn.parallaxSlider=function(o){ 
        ...
        function init(){
            ...
            imgBlocksStructure = !options.liteMode ? "<div id='logo-slider'></div><div id='mainImageHolder'><div class='primaryHolder'><div class='imgBlock'></div></div><div class='secondaryHolder'><div class='imgBlock'></div></div></div>" : "<div id='mainImageHolder'><div class='primaryHolder'><img class='imgBlock' src='' alt=''/></div><div class='secondaryHolder'><img class='imgBlock' src='' alt=''/></div></div>"; 
            ...
            $('.logo a').clone().appendTo('#logo-slider');
